...
MG_VAL = np.array([81,318,348,446,978, 0], np.int64)
EG_VAL = np.array([95,286,306,521,928, 0], np.int64)
_PHW = np.array([0, 1, 1, 2, 4, 0], np.int64)
PHASE_MAX = 24

_MG_PST = np.array([
 [0,0,0,0,0,0,0,0,-81,-50,-69,-73,-52,2,37,-9,
  -78,-54,-49,-47,-20,-15,36,7,-67,-41,-33,-7,-5,-4,27,4,
  -35,-17,-5,11,49,31,70,41,-12,13,4,62,98,121,117,52,
  41,47,54,108,-25,115,24,-98,0,0,0,0,0,0,0,0],
 [-176,-101,-129,-107,-99,-79,-100,-99,-118,-133,-76,-63,-61,-53,-82,-75,
  -107,-61,-46,-45,-3,-44,-29,-75,-61,-51,-10,-45,-26,16,13,-50,
  -36,-4,-30,64,-8,89,26,55,-29,7,-44,107,114,184,97,116,
  -25,-49,115,-22,114,107,56,56,-241,-109,-72,-106,136,-110,15,-196],
 [-60,6,-59,-66,-89,-73,-37,-102,-27,-9,-4,-58,-44,-35,-5,-36,
  -8,-34,-35,-33,-30,-45,-35,-1,-53,-42,-36,7,2,-26,-58,-37,
  -37,-25,13,33,-1,44,-27,-29,-55,45,-63,21,19,-56,79,57,
  -34,-5,7,-107,-68,51,-55,30,-119,-73,-150,-142,-81,-136,11,-64],
 [-98,-77,-68,-58,-45,-73,-13,-97,-126,-93,-90,-92,-76,-70,-53,-104,
  -74,-44,-84,-83,-53,-54,42,22,-73,-79,-83,-75,-54,-77,-28,-41,
  -42,-29,-6,9,6,36,41,24,-1,4,1,60,55,91,121,80,
  42,26,70,103,82,143,103,126,60,36,55,34,112,67,99,127],
 [-48,-76,-64,-31,-46,-94,-82,-25,-88,-56,-34,-24,-24,-30,-21,51,
  -57,-24,-43,-67,-50,-43,-6,7,-35,-86,-68,-63,-50,-53,4,4,
  -46,-54,-70,-55,-13,-43,-4,42,-50,-56,-18,-42,55,97,104,48,
  -70,-77,-46,-50,-46,109,9,126,-110,-41,25,-76,63,39,87,-10],
 [-46,112,72,-106,18,-79,71,20,38,16,6,-53,-65,-40,51,4,
  -64,-22,-46,-96,-113,-111,-97,-126,-143,-68,-116,-124,-152,-151,-136,-158,
  -105,-83,-73,-97,-95,-86,-120,-142,-57,67,44,-5,43,50,2,-104,
  -14,52,15,44,25,30,-19,-78,-55,14,43,-9,-11,-9,-29,-29],
], np.int64)
_EG_PST = np.array([
 [0,0,0,0,0,0,0,0,76,87,67,-24,29,77,54,9,
  45,34,25,18,37,51,24,6,49,51,27,16,11,45,48,25,
  106,76,60,11,1,58,79,49,74,129,114,39,-2,82,128,125,
  127,128,184,146,44,116,145,95,0,0,0,0,0,0,0,0],
 [-104,-134,-80,-82,39,-83,-129,-124,-102,-99,24,-44,-8,-32,-68,-79,
  -87,-56,25,65,58,20,7,-77,-69,65,8,113,105,82,37,-25,
  30,58,92,103,109,87,85,48,30,-43,108,61,51,76,52,-8,
  -29,-8,18,82,85,42,-1,-6,-111,7,31,3,37,41,-61,-148],
 [9,-40,-76,-8,82,-77,-6,-32,-25,-7,20,22,6,20,36,-34,
  32,39,92,64,63,55,11,13,-12,87,96,71,87,69,24,-1,
  39,79,71,96,96,83,85,36,53,60,80,68,69,109,70,78,
  38,61,43,79,71,58,29,29,31,38,69,-8,75,24,62,2],
 [-46,-15,19,8,3,11,-21,-7,-33,-27,-20,-23,-59,-59,-30,27,
  -38,-12,1,-11,-14,-13,-54,-34,36,28,49,37,10,33,33,34,
  53,69,71,48,33,54,38,60,54,52,66,54,38,39,38,59,
  46,41,59,67,52,43,62,53,47,57,84,64,56,87,71,57],
 [-105,-103,-98,-129,-91,-95,-90,17,-83,-85,-102,-100,-83,-95,-67,-25,
  -67,-90,23,12,17,31,-30,-44,-48,21,45,106,72,73,20,44,
  10,18,97,133,130,97,104,83,-26,11,47,120,77,85,73,66,
  7,39,53,112,121,73,11,63,-42,0,20,61,13,7,33,-56],
 [-38,-46,-63,-70,-92,-49,-45,-114,-24,-46,-23,-29,-2,17,-14,-46,
  -47,-11,-5,16,29,14,6,-55,-82,11,44,57,61,50,29,-63,
  -30,66,83,94,90,91,70,-28,-22,83,98,93,103,118,96,35,
  -28,91,98,94,95,105,93,-7,-121,-33,41,41,73,73,7,-98],
], np.int64)
...
_PASS_MG = np.array([0, 6,12,16,34,62,102, 0], np.int64)  # Texel
_PASS_EG = np.array([0, 11,21,36,62,108,178, 0], np.int64)
        ...
        for pt in range(6):
            ...
            while x != U(0):
                ...
                if 1 <= pt <= 4:
                    ...
                    if rh > 0:
                        w = 2 if pt == 1 else (2 if pt == 2 else (4 if pt == 3 else 5))
                        danger[them] += w * rh
        # bishop pair
...
class Engine:
    ...
    def best_move(self, fen, moves, soft_ms, hard_ms, max_depth=64, max_nodes=0):
        import time
        ...
        # max_nodes > 0: fixed-node search for A/B measurement - reproducible,
        # load-insensitive, and (unlike fixed depth) still rewards a change that
        # spends the node budget better. Not used in tournament play.
        fixed_nodes = max_nodes > 0
        self.ct[N_MAXN] = (max_nodes if fixed_nodes
                           else max(60_000, int(self._nps * (hard_ms / 1000.0) * 1.15)))
        ...
        for depth in range(1, max_depth + 1):
            ...
            if abs(score) >= MATE_IN_MAX:
                break
            if fixed_nodes:
                if self.ct[N_NODES] >= max_nodes:
                    break
                continue
            if elapsed * 1000.0 >= soft_ms:
                break
